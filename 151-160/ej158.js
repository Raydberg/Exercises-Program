...
function ordenarJuegosPorPrecio(juegos, orden = 'ASC') {
...
ordenarJuegosPorPrecio(juegos, 'ASC').forEach(juego => juego.imprimirEnPantalla());

console.log('Ordenados por precio descendente:');
ordenarJuegosPorPrecio(juegos, 'DESC').forEach(juego => juego.imprimirEnPantalla());

console.log('Filtrar por la localidad Capital Federal ordenados de manera descendente:');
ordenarJuegosPorPrecio(juegos.filter(juego => juego.localidad === 'Capital Federal'), 'DESC').forEach(juego => juego.imprimirEnPantalla());